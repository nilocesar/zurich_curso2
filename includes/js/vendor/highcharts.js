...
(function(S, K) {
        ...
        a.Color.prototype = {
            ...
            init: function(e) {
                ...
                if ((this.input = e = this.names[e && e.toLowerCase ? e.toLowerCase() : ""] || e) && e.stops) this.stops = I(e.stops, function(e) {
                    ...
                    for (t = this.parsers.length; t-- && !x;) w = this.parsers[t], (f = w.regex.exec(e)) && (x = w.parse(f));
                this.rgba = x || []
            },
            get: function(a) {
                var e = this.input,
    ...
    (function(a) {
        ...
        k(C.prototype, {
            ...
            destroy: function() {
                var a = this,
                    g = a.element || {}, r = a.renderer.isSVG && "SPAN" === g.nodeName && a.parentGroup,
                    d = g.ownerSVGElement,
                    b = a.clipPath;
                g.onclick =
                ...
                if (t !== a.textCache) {
                    ...
                    z || e || B || G || -1 !== c.indexOf(" ") ? (l && l.appendChild(r), c = z ? c.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [c], c = d(c, function(a) {
                        ...
                        p(c, function(g) {
                            if ("" !== g || 1 ===
                                c.length) {
                                var v = {}, l = h.createElementNS(b.SVG_NS, "tspan"),
                                    p, M;
        ...
        a.extend(E.prototype, {
            ...
            renderUnsquish: function() {
                var a = this.chart,
                    ...
                    k = m && m.style || {}, l = this.horiz,
                    h = this.getSlotWidth(),
                    q = Math.max(1, Math.round(h - 2 * (m.padding || 5))),
                    v = {}, A = this.labelMetrics(),
            ...
            renderSplit: function(c, h) {
                ...
                F(c.slice(0, h.length + 1), function(a, c) {
                    if (!1 !== a) {
                        ...
                        var m = c.series || e,
                            A = m.tt,
                            p = c.series || {}, E = "highcharts-color-" + x(c.colorIndex, p.colorIndex, "none");
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function(a, b, k) {
                ...
                u(a, function(a) {
                    ...
                    e = d.dist - a.dist, h = (a.series.group && a.series.group.zIndex) - (d.series.group && d.series.group.zIndex), l = 0 < (0 !== l && b ? l : 0 !== e ? e : 0 !== h ? h : d.series.index > a.series.index ? -1 : 1);
                    l && (d = a)
                });
                return d
            },
        ...
        I(a.Pointer.prototype, {
            ...
            pinch: function(a) {
                var u = this,
                    ...
                    p = u.hasZoom,
                    k = u.selectionMarker,
                    q = {}, d = 1 === c && (u.inClass(a.target, "highcharts-tracker") && t.runTrackerClick || u.runChartClick),
                    b = {};
                1 < c && (u.initiated = !0);
        ...
        a.Series = a.seriesType("line", null, {
            ...
            markerAttribs: function(a, b) {
                var c = this.options.marker,
                    d = a.marker || {}, e = d.symbol || c.symbol,
